	...
	evtFile= (el)->
		...
		$.jqFile
			...
			"error": (state,msg)->
				...
				echo msg
	createFile= (el,btn)->
		#<form action="/agregar-picture" target="ggwc5jwoy0q" method="POST" enctype="multipart/form-data" style="position: absolute; overflow: hidden; opacity: 0; z-index: 99; width: 200px; height: 25px; top: 888px; left: 918px;"><input type="file" name="picture" style="display: block; font-size: 999px; cursor: pointer; width: 200px; height: 25px;"></form>
		form= $("<form />",
			"method": "POST"
